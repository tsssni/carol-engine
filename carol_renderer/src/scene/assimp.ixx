export module carol.renderer.scene.assimp;
...
namespace Carol
{
    ...
    export class AssimpModel : public Model
    {
    public:
        AssimpModel(
            SceneNode *rootNode,
    ...
    protected:
        ...
        void ReadMeshVerticesAndIndices(vector<Vertex> &vertices, vector<uint32_t> &indices, aiMesh *mesh)
        {
