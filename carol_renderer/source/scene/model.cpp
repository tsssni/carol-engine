...
void Carol::Mesh::LoadCullData()
{
	...
	mCullDataBuffer->CopySubresources(gHeapManager->GetUploadBuffersHeap(), mCullData.data(), mCullData.size() * sizeof(CullData), D3D12_RESOURCE_STATE_NON_PIXEL_SHADER_RESOURCE);
