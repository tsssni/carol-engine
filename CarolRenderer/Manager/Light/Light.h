...
namespace Carol
{
    ...
    protected:
        ...
        unique_ptr<LightData> mLightData;
        unique_ptr<Light> mMainLight;
        unique_ptr<DefaultResource> mShadowMap;
        ...
        unique_ptr<ShadowConstants> mShadowConstants;
        unique_ptr<HeapAllocInfo> mShadowCBAllocInfo;
        static unique_ptr<CircularHeap> ShadowCBHeap;
    };
}
